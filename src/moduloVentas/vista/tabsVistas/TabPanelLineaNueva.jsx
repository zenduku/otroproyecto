...
export const TabPanelLineaNueva = () => {
  ...
  const handleSubmit = (event) => {
    ...
    setFormData([
      ...formData, // Copia los elementos previos del array
      {
        ...
        pagoDebito2: inputPagoDebito3.value,
              ...
              <ModalBody>
                ...
                >
                      ...
                      <div>
                        ...
                        {selects.map((select) => (
                          <Flex key={select.id} mb={2}>
                            <Select placeholder="Metodo de Recarga" mr={2}>
                            ...
                            <Select
                              ...
                              mr={2}
                              onChange={(e) =>
                                handleMontoChange(select.id, e.target.value)
                              }
                            >
                  ...
                  <GridItem rowSpan={6} colSpan={1}>
                    ...
                    <FormControl isRequired>
                      <FormLabel htmlFor="inputPagoDebito3">Debito 3</FormLabel>
                      <InputGroup>
                        <InputLeftElement
                          pointerEvents="none"
                          color="gray.300"
              ...
              {formData.map((data, index) => (
                <Tr key={index}>
                  ...
                  <Td>
                    ...
                    <Tr>Monto en Debito3: Bs. {value0(data.pagoDebito3)}</Tr>
